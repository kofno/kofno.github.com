...
identify messages _for our current imap session_. We'll use the UIDs
...
is simply `map _some_function_ uids`. The _some_function_ in this case
is a _composition_ of three functions. The function composition does
...
Every email message _should_ have a Message-ID header that uniquely
